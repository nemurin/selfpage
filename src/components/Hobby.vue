...
export default {
  ...
  data () {
    return {
      ...
      name: '競技かるた',
      star: '★★★',
      text: '高校生の頃から現在までやっています。A級四段を取得しています。'
        },
        {
      name: '競技プログラミング',
      star: '★★★',
      ...
      name: 'ドット絵',
      star: '★★★',
      text: 'ドット絵を書いています。ソフトはEDGEを使用しています。'
        },
        {
      name: '音楽制作',
      star: '★☆☆',
      ...
      name: 'アークナイツ',
      star: '★☆☆',
      text: '5月ごろから最近まで最もハマっているゲームです。課金しようか迷いどころですね。'
        },
        {
      name: '競技プログラミングブログ',
      star: '★☆☆',
      text: 'ほそぼそやってます。自分の解き方についてメモの意味でも作成しています。'
        },
      ]
    }
  }
